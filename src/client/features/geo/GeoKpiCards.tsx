  ...
  return (
    <div className="grid grid-cols-2 gap-4">
      <div className="card bg-base-100 border border-base-200 p-4">
        ...
        <p className="mt-1 text-2xl font-bold">{kpis.tauxPresence}<span className="text-sm font-normal text-base-content/50">%</span></p>
        <p className="mt-1 text-xs text-base-content/40">% des runs sur la période</p>
      </div>
      <div className="card bg-base-100 border border-base-200 p-4">
